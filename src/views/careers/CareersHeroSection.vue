<template>
  <div>
        ...
        <div class="flex flex-wrap items-center gap-y-10">
          <div class="w-1/3 sm:max-md:w-full p-3">
            ...
            <p class="font-inter text-base"> We solve problems that matter and develop technology that respects our
              users. Targeted advertising isn't
              our style. We don't collect anything except more sleep at night.
            </p>
          </div>
          ...
          <div class="w-1/3 sm:max-md:w-full p-3">
            ...
            <p class="font-inter text-base"> Have an immediate impact. Signal is an opportunity to do original work and
              closely collaborate without the overhead of endless meetings.
            </p>
          </div>
          ...
          <div class="w-1/3 sm:max-md:w-full p-3">
            ...
            <p class="font-inter text-base"> Healthcare premiums are fully covered for you and your family. Our 401(k)
              plan matches 100% of your contribution up to $20,500.
            </p>
          </div>
          ...
          <div class="w-1/3 sm:max-md:w-full p-3">
            ...
            <p class="font-inter text-base"> Skip the commute. Work from home or take advantage of our co-working space
              subsidy. Focus on what drives you, not driving.
            </p>
          </div>
          ...
          <div class="w-1/3 sm:max-md:w-full p-3">
            ...
            <p class="font-inter text-base"> Our goal is to protect free expression and enable secure global
              communication. We're working with users to build something sustainable.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="py-12 px-6">
      <div class="container mx-auto 2xl:max-w-[1344px] sm:max-md:max-w-[730px] mt-10">
        ...
        <div>
          <table class="w-full bg-white">
            <tbody>
            <tr class="border-[1px]  border-[#dbdbdb] border-t-0 border-r-0 border-b-[1px] border-l-0 ">
              <td class="py-2 px-3"><b>Product Designer</b></td>
              <td class="py-2 px-3 text-center"> Remote (US Timezones)</td>
              <td class="py-2 px-3"><a class="font-inter text-[#3273dc] cursor-pointer hover:underline" href="#">View Role</a></td>
            </tr>
            <tr class="border-[1px]  border-[#dbdbdb] border-t-0 border-r-0 border-b-[1px] border-l-0 bg-[#fafafa] ">
              <td class="py-2 px-3"><b>Product Designer</b></td>
              <td class="py-2 px-3 text-center"> Remote (US Timezones)</td>
              <td class="py-2 px-3"><a class="font-inter text-[#3273dc] cursor-pointer hover:underline" href="#">View Role</a></td>
            </tr>
      ...
      <p class="font-inter text-base text-center mt-6"> Sorry, we are not seeking interns at this time.</p>
    </div>
  </div>
</template>
